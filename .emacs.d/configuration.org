...
** Key bindings.
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (major-def
       ...
       "c" '(org-edit-src-exit :which-key "commit")
       "q" '(org-edit-src-abort :which-key "quit"))
   #+END_SRC
...
** Helper functions.
   ...
   #+BEGIN_SRC emacs-lisp
     (defun akoppela/conta-serve-frontend ()
       "Starts Conta's frontend 'dev:watch' process."
       (interactive)
       (let ((buffer-name "dev:watch"))
         (if (get-buffer buffer-name)
             (switch-to-buffer buffer-name)
           (progn
             (eshell)
             (rename-buffer buffer-name)
             (insert "cd ~/contadev/front-end/ && npm run dev:watch")
             (eshell-send-input)))))
   #+END_SRC
...
** Key bindings.
   ...
   #+BEGIN_SRC emacs-lisp
     (leader-def
       ...
       "a c s f" '(akoppela/conta-serve-frontend :which-key "frontend"))
   #+END_SRC
