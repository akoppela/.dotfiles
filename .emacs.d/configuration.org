...
**** Varibles.
     ...
     #+BEGIN_SRC emacs-lisp
       (setq my/current-theme 'base16-my-theme)
       (setq my/available-themes (custom-available-themes))
       (setq my/favourite-themes '(base16-my-theme
                                   base16-tomorrow))
     #+END_SRC
...
***** Next theme.
      ...
      #+BEGIN_SRC emacs-lisp
        (my/change-theme my/next-theme "Changes theme to next one" my/available-themes car cdr identity)
        (my/change-theme my/next-favourite-theme "Changes theme to next favourite one" my/favourite-themes car cdr identity)
      #+END_SRC

***** Previous theme.

      #+BEGIN_SRC emacs-lisp
        (my/change-theme my/previous-theme "Changes theme to previous one" my/available-themes -last-item butlast -flip)
        (my/change-theme my/previous-favourite-theme "Changes theme to previous favourite one" my/favourite-themes -last-item butlast -flip)
      #+END_SRC
...
***** Print current theme name.
      ...
      #+BEGIN_SRC emacs-lisp
        (defun my/print-current-theme ()
          "Prints current theme name"
          (interactive)
          (message "Current theme is \"%s\"" my/current-theme))
      #+END_SRC
...
***** Theme hydra.
      ...
      #+BEGIN_SRC emacs-lisp
        (defhydra hydra-change-theme ()
          ...
          ("c" my/print-current-theme "current"))

        (defhydra hydra-change-favourite-theme ()
          "Change favourite theme"
          ("n" my/next-favourite-theme "next")
          ("N" my/previous-favourite-theme "previous")
          ("c" my/print-current-theme "current"))
      #+END_SRC
...
**** Keybindings.
     ...
     #+BEGIN_SRC emacs-lisp
       (leader-def
         ...
         "t a" '(hydra-change-theme/body :which-key "all")
         "t f" '(hydra-change-favourite-theme/body :which-key "favourite"))
     #+END_SRC
