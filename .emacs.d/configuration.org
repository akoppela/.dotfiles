...
*** Frontend root folder.
    ...
    #+BEGIN_SRC emacs-lisp
      (defconst akoppela/conta-frontend-root "~/contadev/front-end/")
    #+END_SRC
...
*** Clean elm stuff.
    ...
    #+BEGIN_SRC emacs-lisp
      (defun akoppela/conta-frontend-elm-clean-stuff ()
        "Cleans Conta's frontend Elm stuff."
        (interactive)
        (akoppela/conta-exec-npm akoppela/conta-frontend-root "elm:clean:stuff"))
    #+END_SRC
...
** Key bindings.
   ...
   #+BEGIN_SRC emacs-lisp
     (leader-def
       ...
       "a c e c" '(akoppela/conta-frontend-elm-clean-stuff :which-key "clean stuff")

       "a c j" '(:ignore t :which-key "javascript")
       "a c j t" '(akoppela/conta-frontend-js-tests :which-key "test")
       "a c j c" '(akoppela/conta-frontend-js-tests-coverage :which-key "coverage"))
   #+END_SRC
