...
** Keybindings.
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (major-def
       ...
       "e a" '(org-ascii-export-as-ascii :which-key "as ascii")
       "e A" '(org-ascii-export-to-ascii :which-key "to ascii")
       "e m" '(org-md-export-as-markdown :which-key "as markdown")
       "e M" '(org-md-export-to-markdown :which-key "to markdown")
