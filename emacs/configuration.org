...
** =desktop-environmet=
   ...
   #+begin_src emacs-lisp
     ...
     (defhydra my/hydra-mic-volume ()
       "Controls mic volume"
       ("+" my/mic-volume-increase "increase volume")
       ("-" my/mic-volume-decrease "decrease volume"))
     ...
     (use-package desktop-environment
       ...
       (leader-def
         "d m" '(my/hydra-mic-volume/body :which-key "mic"))
       :config
...
** Default font
   ...
   #+begin_src emacs-lisp
     ...
     (when (member my/font (font-family-list))
       (set-frame-font (concat my/font " 12") t t))
   #+end_src
...
** Email
   ...
   #+begin_src emacs-lisp
     ...
     (use-package mu4e
       ...
       (setq mu4e-drafts-folder "/akoppela/Drafts")
       (setq mu4e-sent-folder   "/akoppela/Sent Mail")
       (setq mu4e-refile-folder "/akoppela/All Mail")
       (setq mu4e-trash-folder  "/akoppela/Trash")
       (setq mu4e-maildir-shortcuts
             '(("/akoppela/Inbox" . ?i)
               ("/akoppela/Sent Mail" . ?s)
               ("/akoppela/Trash" . ?t)
               ("/akoppela/Drafts" . ?d)
               ("/akoppela/All Mail" . ?a)))
       (leader-def
