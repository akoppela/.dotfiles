...
#+begin_src emacs-lisp
  ...
  (use-package general
    ...
    (leader-def
      ...
      "e N" '(flymake-goto-prev-error :which-key "previous")
      "e l" '(flymake-show-buffer-diagnostics :which-key "list")
      "e L" '(flymake-show-project-diagnostics :which-key "list all")
      ;; Narrow
