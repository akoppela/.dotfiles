    ...
    #+BEGIN_SRC emacs-lisp
      (use-package json-mode
        ...
        (add-hook 'json-mode-hook
                  (lambda () (add-hook 'before-save-hook 'my/sort-json-at-point nil 'local)))
        (major-def
...
** =jenkins=.
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package jenkins
       ...
       (setq jenkins-api-token (nth 1 (auth-source-user-and-password "ci.conta.no")))
       (setq jenkins-username (nth 0 (auth-source-user-and-password "ci.conta.no"))))
   #+END_SRC
